...

{
    ...
    'depends': ['base','mail','hr','account','stock','stock_account','maintenance','maintenance_worksheet','hr_maintenance','fleet_status','branch_routs'],
    ...
    'data': [
        ...
        'views/maintenance_external_job_order_views.xml',
        'views/fleet_vehicle_inherit.xml',
        'views/preventive_maintenance_config.xml',
        'views/stock_picking_inherit.xml',
        'views/account_move_inherit.xml',
        'views/quick_maintenance_request_view.xml',
