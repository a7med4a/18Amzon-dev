...
class NaqlSuspendContractWizard(models.TransientModel):
    ...
    def action_suspend_contract(self):
        """Suspend the contract in Naql system"""
        self.ensure_one()
        ...
        try:
            ...
            if result.get('success'):
                ...
                return {
                    ...
                    'params': {
                        'title': _('Success'),
                        'message': _('Contract suspended successfully in Naql system.'),
                        'type': 'success',
                    }
                }
            else:
            ...
            _logger.error(f"Error suspending Naql contract: {str(e)}")
            self.sta_contract_id.write({
                'sta_status': 'error',
                'error_message': str(e),
            })
