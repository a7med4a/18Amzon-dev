...
class STAAPIController:
    ...
    def _get_config(self):
        """Get STA configuration from system parameters"""
        if not self.env:
            return {}
    ...
    def _make_request(self, method, endpoint, data=None, params=None):
        ...
        try:
            ...
            return {
                'success': False,
                'error': 'Request timeout - STA API did not respond within 30 seconds'
            }
        except requests.exceptions.ConnectionError:
            return {
                'success': False,
                'error': 'Connection error - Unable to connect to STA API'
            }
    ...
    def test_connection(self):
        """Test connection to STA API by getting branches"""
